...
* **run-build-image**: (optional) The name of the image used for the run-build step. Default to `icr.io/continuous-delivery/pipeline/pipeline-base-ubi:3.8`
...
- **extract-value-jq-step-image**: (Default: `icr.io/continuous-delivery/pipeline/pipeline-base-ubi:3.8`) image to use for the extract-value-jq step
...
* **publish-deployable-mapping-step-image**: (optional) image to use for the publish-deployable-mapping step. Default to `icr.io/continuous-delivery/pipeline/pipeline-base-ubi:3.8`
* **pipeline-debug**: (optional) Pipeline debug mode. Value can be 0 or 1. Default to 0
